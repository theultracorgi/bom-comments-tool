...
async function onTariffSubmitClick(tariffTooltipPercent, tariffTooltipValue, tariffTooltipQuantity) {
    ...
    if (tariffTooltipPercent.value != "") {
        tariffValue = "TariffP	" + +tariffTooltipPercent.value;
    } else if (tariffTooltipValue.value != "" && tariffTooltipQuantity.value != "") {
        tariffValue = "TariffV	" + (+tariffTooltipValue.value / +tariffTooltipQuantity.value);
    } else if (tariffTooltipValue.value != "") {
        tariffValue = "TariffV	" + +tariffTooltipValue.value;
    } 
    if (rawBlobText.includes("tarff")) {
            tariffValue = "TariffP	" + rawBlobText.substring(rawBlobText.indexOf('tarff f ') + 10, rawBlobText.indexOf("%") - 1);
    ...
    document.getElementById("tariffTooltipValue").value = "";
    document.getElementById("tariffTooltipQuantity").value = "";
}
